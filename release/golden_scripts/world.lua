...
local words = {
    ...
    portal_all_enemy_size = word("ALL ENEMY SIZE"),
    portal_all_enemy_speed = word("ALL ENEMY SPEED"),
    portal_all_enemy_health = word("ALL ENEMY HEALTH"),
    portal_all_enemy_spawn_herd_size = word("ALL ENEMY SPAWN HERD SIZE"),
    portal_all_enemy_damage = word("ALL ENEMY DAMAGE"),
    portal_all_enemy_spawner_health = word("ALL ENEMY SPAWNER HEALTH"),
    portal_all_enemy_spawn_speed = word("ALL ENEMY SPAWN SPEED"),
    portal_all_enemy_child_capacity = word("ALL ENEMY CHILD CAPACITY"),
...
local text = {
    ...
    child_capacity = { words.child, words.capacity },
